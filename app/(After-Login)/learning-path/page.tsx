...
import { 
  Brain, BookOpen, Play, CheckCircle, Clock, Target, Star, Search,
  ArrowLeft, Filter, Users, Award, TrendingUp, ChevronRight,
  Code, BarChart3, Palette, Shield, Cpu, Lightbulb, Rocket,
  FileText, Video, Headphones, Download, Share2, Eye, Zap, Heart,
  Briefcase, Layers, PenTool, Database
} from "lucide-react"
...
const learningPaths = {
  "Data Scientist": {
    ...
    description: "Menjadi ahli dalam analisis data dan machine learning dengan kemampuan membangun model prediktif dan insights bisnis",
    totalModules: 15,
    ...
    modules: [
      {
        ...
        description: "Pelajari dasar-dasar Python untuk data science mulai dari syntax hingga OOP",
        duration: "2 minggu",
        type: "Course",
        difficulty: "Beginner",
        completed: false,
      ...
      },
      {
        ...
        description: "Konsep statistik yang essential untuk data science dan machine learning",
        duration: "3 minggu",
        type: "Theory",
      ...
      },
      {
        ...
        description: "Master data manipulation menggunakan Pandas library untuk data cleaning dan analysis",
        duration: "2 minggu",
        type: "Hands-on",
        difficulty: "Intermediate",
        completed: false,
  ...
  "Software Engineer": {
    ...
    description: "Menjadi full-stack developer yang handal dengan menguasai teknologi frontend dan backend modern",
    totalModules: 12,
    ...
    modules: [
      {
        ...
        description: "Pelajari dasar-dasar JavaScript modern dengan ES6+ features dan best practices",
        duration: "3 minggu",
        type: "Course",
        difficulty: "Beginner",
        completed: false,
      ...
      },
      {
        ...
        description: "Build modern web applications dengan React dan ecosystem yang powerful",
        duration: "4 minggu",
        type: "Framework",
        difficulty: "Intermediate",
        completed: false,
  ...
  "Product Manager": {
    ...
    description: "Menjadi product manager yang strategic dan data-driven dengan kemampuan leadership yang kuat",
    totalModules: 10,
    ...
    modules: [
      {
        ...
        description: "Dasar-dasar product management dan strategy untuk membangun produk yang user-centric",
        duration: "2 minggu",
        type: "Theory",
        difficulty: "Beginner",
        completed: false,
  ...
  "UI/UX Designer": {
    ...
    description: "Menjadi designer yang user-centric dan kreatif dengan kemampuan research dan prototyping",
    totalModules: 8,
    ...
    modules: [
      {
        ...
        description: "Memahami proses design thinking dan user research untuk menciptakan solusi yang tepat",
        duration: "2 minggu",
        type: "Theory",
        difficulty: "Beginner",
        completed: false,
        ...
        projects: 2,
        content: {
          lessons: ["Design Process", "User Research", "Empathy Mapping", "Problem Definition"],
...
export default function LearningPathPage() {
  ...
  const getDifficultyColor = (difficulty: string) => {
    switch (difficulty) {
      case 'Beginner': return 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-300 border-emerald-200 dark:border-emerald-700'
      ...
      case 'Advanced': return 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 border-red-200 dark:border-red-700'
      default: return 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-600'
    }
  }

  const getTypeIcon = (type: string) => {
    switch (type) {
      case 'Course': return <BookOpen className="w-4 h-4 text-white" />
      case 'Theory': return <FileText className="w-4 h-4 text-white" />
      case 'Hands-on': return <Code className="w-4 h-4 text-white" />
      case 'Framework': return <Rocket className="w-4 h-4 text-white" />
                  ...
                  <div className="relative p-6">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        <Button size="sm" className="bg-white/20 text-white border border-white/30 hover:bg-white/30 rounded-lg text-xs">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-white/90 text-sm mb-3">{currentPath.description}</p>
                        <div className="flex items-center gap-6">
                          <div className="flex items-center gap-2">
                            <Star className="w-4 h-4 text-yellow-400 fill-current" />
                            <span className="text-white text-sm font-semibold">{currentPath.rating}</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Users className="w-4 h-4 text-white/80" />
                            <span className="text-white text-sm">{currentPath.students.toLocaleString()} siswa</span>
                          </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-xl font-bold">
                            {currentPath.modules.filter((m: any) => m.completed).length}
                          </div>
                ...
                <Card className="p-6 border-0 shadow-lg bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm">
                  ...
                  <div className="mb-4">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Kemajuan Keseluruhan</span>
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-white/90 text-sm">
                          Pilih jalur pembelajaran yang sesuai dengan tujuan karier Anda
                        </p>
                      </div>
                    </div>
              ...
              <Card className="p-5 border-0 shadow-lg bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm">
                <div className="flex flex-col lg:flex-row gap-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-medium text-slate-600 dark:text-slate-400">Difficulty:</span>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {['Technology', 'Design', 'Business', 'Analytics'].map((category) => (
                        <Button
                          key={category}
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-1 text-slate-500 dark:text-slate-400">
                              ...
                              <span className="text-sm">{path.students.toLocaleString()}</span>
                            </div>
                          </div>
