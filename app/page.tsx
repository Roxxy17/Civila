...
export default function HomePage() {
  ...
  const testimonials = [
    {
      ...
      content:
        "Civila membantu saya menemukan passion di bidang UX Design. Dalam 3 bulan, saya sudah bekerja di startup impian dengan gaji 2x lipat!",
      rating: 5,
      image: "SW",
    },
    {
      ...
      content:
        "Roadmap pembelajaran yang dipersonalisasi sangat membantu transisi karier saya dari marketing ke data science. AI mentornya luar biasa!",
      rating: 5,
      image: "AR",
    },
    {
      ...
      company: "Global Tech",
      content:
        "AI mentor 24/7 selalu siap membantu ketika saya stuck. Sekarang saya menjadi PM di perusahaan global. Game changer banget!",
      rating: 5,
      image: "DP",
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "Analisis mendalam tentang skill gap dan rekomendasi karier berdasarkan minat, bakat, dan tren pasar kerja terkini dengan akurasi 95%.",
    ...
    },
    {
      ...
      description:
        "Roadmap pembelajaran step-by-step yang disesuaikan dengan tujuan karier dan gaya belajar kamu. Hemat 60% waktu belajar!",
    ...
    },
    {
      ...
      description:
        "Chat interaktif dengan AI mentor yang siap membantu kamu kapan saja untuk diskusi karier, motivasi, dan problem solving.",
    ...
    },
    {
      ...
      description:
        "Pantau perkembangan skill dan pencapaian dengan visualisasi yang menarik, gamifikasi, dan milestone rewards yang memotivasi.",
    ...
    },
    {
      ...
      description:
        "Bangun portfolio digital yang menampilkan skill dan pencapaian kamu untuk menarik perhatian recruiter top company.",
    ...
    },
    {
      ...
      description:
        "Bergabung dengan komunitas 10K+ learner yang saling mendukung, berbagi pengalaman, dan networking karier.",
  ...
  const stats = [
    ...
    },
    {
      ...
      sublabel: "berdasarkan survei",
      icon: Heart,
    },
    {
      number: "24/7",
      label: "AI Support",
      sublabel: "siap membantu kapan saja",
      icon: Zap,
    },
  ];
  ...
  const videoUrl = "https://www.youtube.com/watch?v=9LcKaNDp_q8";
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto text-center w-full">
          ...
          >
            ...
            <div className="mb-8">
              <Badge
                variant="secondary"
                className="text-sm px-8 py-3 bg-gradient-to-r from-purple-100 via-blue-100 to-cyan-100 dark:from-purple-900/30 dark:via-blue-900/30 dark:to-cyan-900/30 text-purple-700 dark:text-purple-300 border-0 font-semibold shadow-lg animate-bounce-slow"
              >
            ...
            <p className="text-2xl md:text-3xl text-slate-600 dark:text-slate-300 mb-12 text-pretty max-w-4xl mx-auto leading-relaxed">
              Platform AI terdepan yang membantu kamu menemukan passion,
              mengembangkan skill, dan meraih karier impian dengan roadmap
              pembelajaran yang dipersonalisasi dan mentor AI 24/7.
            </p>

            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              <Button
                size="lg"
                className="text-xl px-14 py-7 pulse-glow btn-hover-lift shadow-2xl shadow-primary/30 bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 hover:from-purple-700 hover:via-blue-700 hover:to-cyan-700 border-0 text-white"
                asChild
              >
                <Link href="/register">
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-xl px-14 py-7 bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-slate-300 dark:border-slate-600 hover:bg-white/80 dark:hover:bg-slate-800/80 btn-hover-lift shadow-xl text-slate-700 dark:text-slate-200"
                asChild
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {stats.map((stat, index) => (
              <div
                ...
                style={{
                  animationDelay: visibleElements.has(`stat-${index}`)
                    ? `${index * 150}ms`
                    : "0ms",
                }}
              >
      ...
      {/* Enhanced Demo Video Section with Real YouTube Video */}
      {/* Enhanced Demo Video Section with Real YouTube Video */}
      <section id="demo-video" className="relative z-10 px-6 py-24">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <Badge
              variant="outline"
              className="mb-6 px-6 py-2 text-slate-700 dark:text-slate-300 border-slate-300 dark:border-slate-600"
            >
              🎬 Demo Video
            </Badge>
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Discover bagaimana AI kami bekerja untuk menemukan karier impianmu
              dalam 3 langkah sederhana. Ribuan orang sudah membuktikan
              keampuhannya!
            </p>

            <div className="relative aspect-video bg-gradient-to-br from-slate-100 via-white to-slate-200 dark:from-slate-800 dark:via-slate-900 dark:to-slate-800 rounded-3xl overflow-hidden group shadow-2xl hover:shadow-3xl transition-all duration-500 border border-slate-200 dark:border-slate-700">
              ...
              {!showVideo ? (
                <>
                  ...
                  <div
                    className="absolute inset-4 bg-gradient-to-br from-slate-200 to-slate-300 dark:from-slate-700 dark:to-slate-800 rounded-2xl flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-[1.02]"
                    onClick={handleVideoPlay}
                  >
                    <div className="text-center">
                      <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-200 mb-2">
                        Demo: Temukan Karier Impianmu
                      </h3>
                      <p className="text-slate-600 dark:text-slate-400 mb-8">
                        Klik untuk memutar video • Bahasa Indonesia • Full HD
                      </p>

                      {/* Single Play Button - Centered */}
                      <div className="w-20 h-20 bg-red-600 rounded-full flex items-center justify-center shadow-2xl mx-auto group-hover:scale-110 transition-transform duration-300 hover:bg-red-700">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="font-semibold text-slate-800 dark:text-slate-200 text-lg">
                            Tutorial Lengkap Civila AI
                          </h3>
                          <p className="text-sm text-slate-600 dark:text-slate-400">
                            Dari registrasi hingga dapat job offer
                          </p>
                        </div>
                ...
                <>
                  ...
                  <button
                    ...
                    className="absolute top-4 right-4 z-20 w-10 h-10 bg-black/70 hover:bg-black/90 rounded-full flex items-center justify-center text-white transition-all duration-200 hover:scale-110"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
            ...
            <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-lg px-8 py-4 text-slate-700 dark:text-slate-300 border-slate-300 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-800"
              >
                <a
                  href={videoUrl}
                  target="_blank"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-2xl text-slate-600 dark:text-slate-300 max-w-4xl mx-auto leading-relaxed">
              Teknologi AI terdepan yang memahami potensi unik kamu dan
              memberikan panduan karier yang tepat sasaran dengan metodologi
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                ...
                style={{
                  animationDelay: visibleElements.has(`feature-${index}`)
                    ? `${index * 100}ms`
                    : "0ms",
                }}
              >
                <Card className="p-8 h-full bg-white/70 dark:bg-slate-800/70 backdrop-blur-md border-slate-200 dark:border-slate-700 hover:bg-white/90 dark:hover:bg-slate-800/90 transition-all duration-500 group-hover:scale-105 group-hover:shadow-2xl group-hover:-translate-y-2">
                  <div className="relative mb-6">
                    <div
                      className={`w-16 h-16 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:shadow-xl`}
                    >
                      <feature.icon className="w-8 h-8 text-white" />
                    </div>
                    <Badge
                      variant="secondary"
                      className="text-xs px-3 py-1 bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-900/30 dark:to-blue-900/30 text-purple-700 dark:text-purple-300 border-0"
                    >
                      {feature.badge}
                    </Badge>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 mb-10 leading-relaxed">
                Dengan teknologi AI terdepan dan metodologi yang terbukti,
                Civila membantu mempercepat perjalanan karier impianmu hingga 3x
                ...
                <div className="aspect-square bg-gradient-to-br from-purple-500 via-blue-500 to-cyan-500 rounded-3xl p-8 text-white overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500">
                  ...
                  <div className="h-full flex flex-col justify-between">
                    <div>
                      ...
                      <div className="text-7xl font-bold mb-6 bg-gradient-to-r from-white to-cyan-200 bg-clip-text text-transparent">
                        98%
                      </div>
                      <p className="text-xl opacity-90 leading-relaxed">
                        Pengguna berhasil menemukan jalur karier yang tepat dan
                        mendapat job offer dalam 60 hari
                      </p>
                    </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed">
              Dengar cerita sukses dari ribuan pengguna yang telah mengubah
              hidup dan meraih karier impian dengan Civila.
            </p>
          </div>
              ...
              <Card className="p-12 text-center bg-white/70 dark:bg-slate-800/70 backdrop-blur-md border-slate-200 dark:border-slate-700 shadow-2xl">
                ...
                <div className="flex items-center justify-center gap-6 mb-6">
                  ...
                  <div className="text-left">
                    <div className="font-semibold text-xl text-slate-900 dark:text-white">
                      {testimonials[currentTestimonial].name}
                    </div>
                    <div className="text-indigo-600 dark:text-indigo-400 font-medium text-lg">
            ...
            <Card className="p-16 bg-white/70 dark:bg-slate-800/70 backdrop-blur-md border-slate-200 dark:border-slate-700 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-2xl text-slate-600 dark:text-slate-300 mb-12 max-w-4xl mx-auto leading-relaxed">
                  Bergabung dengan 15K+ profesional yang telah menemukan jalur
                  karier impian mereka. Mulai perjalananmu hari ini dan rasakan
                  perbedaannya dalam 7 hari!
                </p>
                <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
                  <Button
                    size="lg"
                    className="text-xl px-16 py-8 pulse-glow btn-hover-lift shadow-2xl shadow-primary/30 bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 hover:from-purple-700 hover:via-blue-700 hover:to-cyan-700 border-0 text-white"
                    asChild
                  >
                    <Link href="/register">
                      <Rocket className="mr-3 w-6 h-6 animate-bounce" />
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="text-xl px-16 py-8 bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border-slate-300 dark:border-slate-600 hover:bg-white/80 dark:hover:bg-slate-800/80 text-slate-700 dark:text-slate-300"
                    asChild
                  >
